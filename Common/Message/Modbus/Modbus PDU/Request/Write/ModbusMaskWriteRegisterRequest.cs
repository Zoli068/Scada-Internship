...
{
    /// <summary>
    /// Implentation of the <see cref="IModbusMaskWriteRegisterRequest"/> interface
    /// </summary>
    public class ModbusMaskWriteRegisterRequest : IModbusMaskWriteRegisterRequest
    {
        private ushort referenceAddress;
        private ushort andMask;
        private ushort orMask;

        public ModbusMaskWriteRegisterRequest() { }
        
        public ModbusMaskWriteRegisterRequest(ushort referenceAddress,ushort andMask,ushort orMask)
        {
